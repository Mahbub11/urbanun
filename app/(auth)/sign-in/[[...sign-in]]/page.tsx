...
export default function Page() {
  ...
  return (
    <section className="bg-white px-10  rounded-md">
      <div className="lg:grid lg:min-h-full  lg:grid-cols-12 items-center">
        <section
          className="relative flex items-end  lg:col-span-5 
        ...
        >
          ...
          <div className=" h-[50rem]">
            <Image
              ...
              alt=""
              src="https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              className="absolute rounded-md inset-0 h-full w-full object-cover opacity-80"
            ></Image>
          </div>
