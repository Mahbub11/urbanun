  ...
  return (
    <div className="md:px-5 font-montreal text-gray-700">
      <div className={`w-full md:py-10 bg-[#EDF9F9]`}>
        <div className="w-full  md:w-[90%] lg:w-[70%] sm:py-5
         md:py-[5rem] mx-auto sm:pt-3 " ref={sectionRef}>
          <div className="w-full h-full sm:flex-col
           ...
           sm:justify-center items-center sm:ml-2">
            ...
            <div className="font-[450] sm:ml-4 w-[80%]">
              <div className="">
                <h2 className="font-gvf sm:text-[30px] md:text-[30px] 
                lg:text-[40px] font-[500] md:mt-[-2rem] tracking-tight leading-tight">
